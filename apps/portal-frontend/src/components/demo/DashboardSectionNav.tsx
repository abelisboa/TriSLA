const SECTIONS = [
  ...
  { id: "section-raw-payload", label: "Raw Payload", level: 7 },
] as const;

export function DashboardSectionNav() {
  return (
    <nav className="trisla-section-nav" aria-label="Dashboard sections">
      <p className="trisla-section-nav-label">Reviewer navigation</p>
