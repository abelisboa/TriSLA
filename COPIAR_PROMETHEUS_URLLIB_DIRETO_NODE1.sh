#!/bin/bash
# Copiar prometheus.py com urllib diretamente (sem precisar do arquivo local)
...
echo "📦 Criando prometheus.py com urllib diretamente no pod..."

# Criar conteúdo completo do prometheus.py
...
echo ""
echo "✅ Arquivo criado! Reiniciar deployment para carregar."
