...
- Arquivos SLA: 3
- IDs extraídos (únicos): 3
- ✅ Há IDs de SLA/Decisão extraídos do Portal (fonte real)
- ⚠️ Há indícios de falhas em respostas do Portal (ver SLA_FALHAS.txt)

## FASE 4 — Auditoria Decision Engine — 04_decisions/
- Decisões encontradas (RENEG/ACCEPT/REJECT): 10
...
- Chamadas /predict vistas: 6
- Indicadores de fallback: 6 linhas
...
Consumindo amostra de trisla-ml-predictions...
