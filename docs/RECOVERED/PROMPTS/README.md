...
|----------|------|---------|
| `VALIDACAO_FINAL_E2E_RAN_REAL.md` | RAN E2E validation evidence | LINK_ARCHIVED - source not present in current tree |
| `VALIDACAO_TECNICA_XAI_SUBMIT.md` | XAI submit technical validation | LINK_ARCHIVED - source not present in current tree |
| `TRISLA_DIRETRIZES_RAN_E2E.md` | RAN E2E directives | LINK_ARCHIVED - source not present in current tree |
| `ACCEPTANCE_CRITERIA_TELEMETRY_V2.md` | Telemetry v2 acceptance | LINK_ARCHIVED - source not present in current tree |
...
| File | Role | Cleanup |
|------|------|---------|
| `backup/prompts/PROMPT_33_AUDITORIA_ALINHAMENTO_METRICAS_3_DOMINIOS_NASP_V1.md` | 3-domain NASP metrics audit | LINK_ARCHIVED - backup source not present in current tree |
| `backup/prompts/PROMPT_34_PLANO_REALINHAMENTO_DOMINIOS_RAN_TRANSPORT_CORE_V1.md` | RAN/transport/core realignment plan | LINK_ARCHIVED - backup source not present in current tree |
| `backup/prompts/PROMPT_35_CHECKLIST_PRs.md` | PR checklist | LINK_ARCHIVED - backup source not present in current tree |

## Collection / campaigns

| Document | Role | Cleanup |
|----------|------|---------|
| `TRISLA_FINAL_EVIDENCE_CAMPAIGN.md` | Evidence campaign | LINK_ARCHIVED - source not present in current tree |
| `CURSOR_WORKFLOW_RULES.md` | Cursor / agent workflow rules | LINK_ARCHIVED - source not present in current tree |
