...
- NASP Adapter provides integration and orchestration context.
- Decision-critical RAN load (modeled PRB) and transport variability (jitter probes) are produced outside NASP Adapter and fused upstream in telemetry snapshots.
