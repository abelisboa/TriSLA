...
_DEFAULT_RAN_PRB = 'avg(trisla_ran_prb_utilization{job="trisla-ran-ue-upf-proxy"})'
_DEFAULT_CORE_CPU = (
...
def main() -> int:
    ...
    ran_prb, ran_prb_q_used = _prom_first_valid(
        prom,
        [ran_prb_q, 'avg(trisla_ran_prb_utilization{job="trisla-ran-ue-upf-proxy"})'],
    )
