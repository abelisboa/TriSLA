#!/bin/bash
# Script para push da imagem Docker do frontend para ghcr.io
...
if ! docker image inspect "$IMAGE_NAME" > /dev/null 2>&1; then
    ...
    echo "💡 Execute primeiro: ./scripts/build_frontend.sh"
    exit 1
fi
...
echo "✅ Frontend image pushed successfully to ghcr.io"
