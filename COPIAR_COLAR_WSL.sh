#!/bin/bash
# ================================================================
# COPIE E COLE ESTE COMANDO COMPLETO NO TERMINAL WSL
# ================================================================
# Execute: cd ~/trisla-dashboard-local/scripts-wsl && cat > dashboard-menu.sh << 'MENUEOF'
# [Depois cole o conteúdo abaixo]
# MENUEOF
# chmod +x dashboard-menu.sh && ./dashboard-menu.sh
